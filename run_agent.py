...
from agent.prompt_builder import build_skills_system_prompt, build_context_files_prompt, build_environment_hints, load_soul_md, load_gateway_org_defaults, TOOL_USE_ENFORCEMENT_GUIDANCE, TOOL_USE_ENFORCEMENT_MODELS, GOOGLE_MODEL_OPERATIONAL_GUIDANCE, OPENAI_MODEL_EXECUTION_GUIDANCE
...
class AIAgent:
    ...
    def _build_system_prompt(self, system_message: str = None) -> str:
        ...
        # Deployment-rendered org defaults; absent on vanilla upstream installs.
        if not self.skip_context_files:
            _org_defaults = load_gateway_org_defaults()
            if _org_defaults:
                prompt_parts.append(_org_defaults)
