...
def ensure_hermes_home():
    ...
    The default SOUL.md is seeded at runtime for normal installs and upgraded
    in place only when the existing file is still the legacy empty scaffold.
    """
...
def _ensure_hermes_home_managed(home: Path):
    """Managed-mode variant: verify dirs exist and seed SOUL.md."""
    if not home.is_dir():
        raise RuntimeError(
