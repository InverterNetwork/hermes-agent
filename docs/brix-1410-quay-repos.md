...
| `brix-prototypes` | `https://github.com/InverterNetwork/brix-prototypes` | `main` | `bun` | `cd looping/backend && bun install && cd ../frontend && bun install` |
...
| `itry-liquidation-bot` | `https://github.com/InverterNetwork/itry-liquidation-bot` | `main` | `pnpm` | `pnpm install --frozen-lockfile` |
